...
const TaskCard = (
    {
        ...
        return (
            <div className={className} style={{position:"relative", alignSelf: "start", ...style}}>
                <Form fields={(type == "recurring") ? recurringTaskFields : additionalTaskFields} onSubmit={onSubmit} ref={ref} buttons={buttons} buttonAreaStyle={buttonAreaStyle} initialValues={initialValues} style={{padding: "2rem", paddingTop:"6rem"}}/>
